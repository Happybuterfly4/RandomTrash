...
function renderSounds(filter = '') {
    ...
    finalSound.forEach(sound => {
        ...
        button.onclick = () => {
            ...
            const audio = new Audio("cdn.jsdelivr.net/gh/Happybuterfly4/RandomTrash/soundboard@main/"+sound.mp3);
            audio.play();
...
function rightClickPanel(event, button, sound) {
    ...
    download.onclick = () => {
        ...
        link.href = 'cdn.jsdelivr.net/gh/Happybuterfly4/RandomTrash/soundboard@main/'+sound.mp3;
